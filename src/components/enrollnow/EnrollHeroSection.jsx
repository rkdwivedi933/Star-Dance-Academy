...
export default function EnrollHeroSection() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-black">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1529229504105-4ea795dcbf59?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NjN8fGRhbmNlcnxlbnwwfHwwfHx8MA%3D%3D')",
