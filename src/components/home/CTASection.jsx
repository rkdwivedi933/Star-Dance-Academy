        ...
        >
          ...
          <div className="lg:max-w-2xl">
            ...
            >
              ...
              From classical dance to energetic Zumba and unforgettable wedding choreography 
              – your perfect dance experience awaits.
            </motion.p>
          </div>
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative px-4 py-2   text-white rounded-full font-bold text-lg shadow-2xl overflow-hidden transition-all duration-300"
              style={{
                  background: `linear-gradient(135deg, var(--color-primary) 0%, var(--color-secondary) 100%)`,
                  color: "white",
                }}
            >
              <span onClick={handleEnrollButton} className="relative z-10 flex items-center justify-center gap-2">
                Enroll Now
