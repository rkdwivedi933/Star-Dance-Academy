...
export default function ZumbaCTA() {
...
const handleEnroll = () =>{
  ...
  return (
    <section className="w-full min-h-full flex items-center justify-center px-4 py-6 relative overflow-hidden bg-linear-to-br from-primary via-primary to-secondary">
      ...
      >
        ...
        >
          ...
          <span className="inline-block mt-2">Zumba Class?</span>
        </motion.h2>
