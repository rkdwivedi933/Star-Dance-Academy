...
export default function ServicesCTA() {
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto text-center  ">
          ...
          <motion.div
            ...
            className="w-24 md:w-32 h-1 bg-white/80 rounded-full mx-auto mb-2 md:mb-4"
          />
          ...
          <motion.h2
            ...
            className="text-xl md:text-3xl lg:text-4xl font-bold text-white mb-2 md:mb-2 leading-tight px-4"
          >
            Book Your Family Function Choreography
          </motion.h2>
          ...
          <motion.p
            ...
            className="text-white/90 text-base sm:text-lg lg:text-xl mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed"
          >
  ...
  <motion.div
          ...
          >
            ...
            {/* Info text */}
            <p className="text-white/80 text-xs sm:text-sm mt-6 sm:mt-8">
              Available for weddings, sangeet nights, and all family celebrations
            </p>
