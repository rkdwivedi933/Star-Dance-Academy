...
const galleryImages = [
  ...
  {
    id: 4,
    url: "https://images.unsplash.com/photo-1587271636175-90d58cdad458?w=800&q=80",
    alt: "Wedding decor",
  ...
  return (
    <div className="min-h-screen p-8" style={{ backgroundColor: 'var(--color-elegantLight)' }}>
      <style>{`
        @theme {
  ...
  style={{
    boxShadow: '0 0 20px rgba(246, 70, 108, 0.2), 0 0 30px rgba(242, 139, 0, 0.15)'
  }}
>
              ...
              />
              <div 
                className="absolute inset-0 bg-linear-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-6"
              >
